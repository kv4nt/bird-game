...
function checkCollisions() {
    ...
    for (let p of pipes) {
        ...
        if ((pipes[0].x <= bird.x || (pipes[0].x < bird.x && pipes[0].x + pw > bird.x) || pipes[0].x + pw <= bird.x) && bird.y <= pipes[0].y) {
            console.log('v1',pipes[0].x <= bird.x);
            console.log('v2',pipes[0].x >= bird.x + pw);
            console.log('v3',pipes[0].x + pw <= bird.x);
            console.log('v4',bird.y <= pipes[0].y);
            console.log('v2-v5',(pipes[0].x < bird.x && pipes[0].x + pw > bird.x));
            console.log('p',p);
            console.log('bird',bird);
